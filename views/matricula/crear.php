...
<head>
    <meta charset="UTF-8">
    <title>Asignar Matricula</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css">
</head>
<body>
    <div class="container mt-5">
        <h1>Asignar Matricula</h1>
    ...
    <?php if ($estudiante): ?>
        <h2 class="mt-4">Datos del Estudiante</h2>
        ...
        <input type="hidden" name="cedula" value="<?= htmlspecialchars($_POST['cedula'] ?? '') ?>">
                ...
                <?php if (!empty($jornadas)): ?>
                    <div class="form-group">
                        <label>Seleccione solo una Jornadas:</label>
                ...
                <div class="form-group">
                    <label>Seleccione solo un Paralelos:</label>
